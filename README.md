...
I'm a **full-stack & systems engineer** currently serving as **Founding Engineer at Cherry Dating**, where I own the entire backend - from geospatial proximity matching to real-time WebSocket infrastructure - serving **5,000+ daily active users** with zero downtime and sub-200ms latency at scale. I'm a pre final year at **IIIT Bhopal (B.Tech IT, 2023–2027)** with production experience across three companies spanning India and Malaysia.
